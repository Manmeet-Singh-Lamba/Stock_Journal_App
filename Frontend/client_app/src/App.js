      ...
      <div className="container">
        ...
        <Routes>
          <Route
            ...
            element={
              user_token && user_token !== "" ? (
                <Home user_token={user_token} />
              ) : (
                <Login catchUser_token={catchUser_token} />
              )
            }
          />
          <Route
          ...
          <Route
            path="/Login"
            element={<Login catchUser_token={catchUser_token} />}
          />
          <Route path="/SignUp" element={<SignUp />} />
          <Route
            path="/notes/:ticker_symbol"
            element={
              user_token && user_token !== "" ? (
                <NoteDisplay user_token={user_token} />
              ) : (
                <Login catchUser_token={catchUser_token} />
              )
            }
